...
DSM_6_API_INFO = {
    "data": {
        ...
        "SYNO.Docker.DDSM.Image": {
            "maxVersion": 1,
            "minVersion": 1,
            "path": "entry.cgi",
            "requestFormat": "JSON",
        },
        "SYNO.Docker.DDSM.Network": {
            "maxVersion": 1,
            "minVersion": 1,
            "path": "entry.cgi",
            "requestFormat": "JSON",
        },
        "SYNO.Docker.DDSM.Network.Setting": {
            "maxVersion": 1,
            "minVersion": 1,
            "path": "entry.cgi",
            "requestFormat": "JSON",
        },
        "SYNO.Docker.DDSM.Restore": {
            "maxVersion": 1,
            "minVersion": 1,
            "path": "entry.cgi",
            "requestFormat": "JSON",
        },
        "SYNO.Docker.DDSM.Server": {
            "maxVersion": 1,
            "minVersion": 1,
            "path": "entry.cgi",
            "requestFormat": "JSON",
        },
        "SYNO.Docker.DDSM.Update": {
            "maxVersion": 1,
            "minVersion": 1,
            "path": "entry.cgi",
            "requestFormat": "JSON",
